...
List<Post> posts = [
  Post(
    ...
    posttext:
        "As someone who has lived with their grandparents since young, helping the elderly comes innate to me.
        The satisfaction of helping them with simple tasks is unparalled with any of the feats I have achieved
        in my Machine Learning endeavours. Strongly urge all to join me next week as",
    timeAgo: '2d',
    totalComments: '300',
    totalLikes: '23',
  ...
  Post(
    ...
    postimage:
        'https://live.staticflickr.com/65535/52172333362_e735b8bfaa.jpg',
    posttext:
        "I wrote my first hello world at the age of 8 and immediately fell in love with the art of coding.
        Unlike me, most of my peers did not have the opportunity to discover their potential passion for 
        coding at a young age, which may hinder their performace. CodeCamp allows me to ensure this does 
        not happen as I am able to teach kids how to code, and introduce them to the beutiful art of coding.
        I hope that with this, more kids start coding and continue it when they're older.",
    timeAgo: '2d',
    totalComments: '300',
    totalLikes: '23',
  ...
  Post(
    ...
    postimage:
        'https://live.staticflickr.com/65535/48320611806_9e36b6b2dd.jpg',
    posttext:
        "I have found that among its other benefits, giving liberates the soul of the giver. Helping the less
        privileged has always been a religion to me, and I have started my own organisation to make my vision
        a reality. Outreach like this not helps those in need, but also allows us as humans to gain some peace,
        and I find that really beautiful. No one can replace the smile that you bring to others. Keep it going 
        everyone! P.S. Raveen, you're amazing.",
    timeAgo: '2d',
    totalComments: '300',
    totalLikes: '23',
  ...
  Post(
    ...
    posttext: "Money is not the only commodity that is fun to give. We can give time, we can give our expertise, 
    we can give our love, or simply give a smile. What does that cost? The point is, none of us can ever run out 
    ...
    useravatar:
        "https://nuscomputing.com/assets/LoZhaoWei.jpg",
  ),
  Post(
    username: "Roy Chua",
    postimage:
        'https://live.staticflickr.com/879/42889990962_cb348e9a9f.jpg',
    posttext: "As we begin our journey of giving, it's important that we ourselves stay fit and healthy for the 
    task at hand. Training our volunteers is just one of the many things I love to do, and I urge all other
    organisations to do the same and ensure the well-being of their volunteers.",
    timeAgo: '2d',
    totalComments: '300',
    totalLikes: '23',
    userCaption: 'People Person | CPO @ BeepBeep',
    useravatar:
        "https://nuscomputing.com/assets/RoyChua.jpg",
  ),
  Post(
    username: "Alyssa Savier",
    postimage:
        'https://live.staticflickr.com/4545/38292907322_9d9b9fd908.jpg',
    posttext: "I am really proud of the hardwork and effort put in place to make ComClub a success. I am thankful
    for everyone taking time off their busy schedules to do something for the community. I hope everyone had a great
    time and see the fruits of their labour; I'm sure the beneficiaries have! ",
    timeAgo: '2d',
    totalComments: '300',
    totalLikes: '23',
    userCaption: 'Safety @TikTok | Community Manager',
    useravatar:
        "https://nuscomputing.com/assets/AlyssaSavier.jpg",
  ),
];
...
var PROJECTS_CATEGORIES = [
  ...
  Projects(
    ...
    description:
        "As our world continues to rapidly digitalise, it is becoming increasingly more difficult for the elderly to keep up as there is always something new to learn about. Furthermore, as the pandemic continues to separate families, it is more difficult for the elderly to get help with technology from their loved ones and also keep in touch with them.
        For this reason, the Elderly Service Committee from the NUS Students Computing Club will be collaborating with Heartware Network to host a Digital Learning Workshop dedicated to the elderly. Over the course of four sessions, volunteers will guide seniors on different digital services, depending on what the seniors would like help with. We will 
        also have specific lesson plans on topics we would like to share with the elderly, which includes: how to avoid and discern scam attempts, setting up social media accounts to keep in touch with their loved ones, teaching them how to use cashless payment methods - such as Paylah! and GrabPay, or how to use food delivery apps like Foodpanda or Grab. This workshop will be a weekly Saturday event during the month of June, lasting around 2 hours per session, and hosted in collaboration with Heartware Network."
    fundings_recieved: 43000,
    fundings_needed: 100000,
    manpower: "27 / 100",
    organisation: "NUS Students Computing Club",
